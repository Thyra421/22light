...
import { getRoles } from "../../client/Helper/LoginHelper"
import {
...
export default function Login() {
  ...
  const loginRequest = async () => {
    try {
      const userInfo = await signInWithEmailAndPassword(auth, login, password);
  ...
  const loggedStateFirebase = async () => {
    window.localStorage.setItem("logged", "true");
    window.localStorage.setItem("email", auth.currentUser.email);
    window.localStorage.setItem("uid", auth.currentUser.uid);
    ...
    <div className="login-Container">
      ...
      <div className="login-Contain">
        ...
        <Link to="/register" className="link">
          <li className="login-registerLink">Register your account</li>
        </Link>
      </div>
    </div>
  );
